...
const data = [
    ...
    //category's
    { name: "Western", link: "category.html#western", categories: ["category"] },
    { name: "Noodle", link: "category.html#noodle", categories: ["category"] },
    { name: "Dessert", link: "category.html#dessert", categories: ["category"] }, //have to assign categories for them as well or else it might malfunction when grabbing random category page (maybe because not complete?)
...
function searchFunction() {
    ...
    ); //includes check if it's present, maybe.
